...
const ingredientSeeds: IngredientSeed[] = [
  ...
  { name: "Nueces", purchaseUnit: "KILOGRAM", purchaseQuantity: 1, purchasePrice: 9000 },
];
...
const productSeeds: ProductSeed[] = [
  ...
  // Decoraciones clásicas — cartas reales de Ciocolatto
  {
    type: "DECORATION",
    name: "Selva Negra",
    description: "Crema chantilly, virutas de chocolate y frutillas frescas.",
    visualStyle: "selvanegra",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 1,
    recipe: [
      { ingredient: "Crema de leche", quantity: 400 },
      { ingredient: "Azúcar impalpable", quantity: 60 },
      { ingredient: "Chocolate cobertura", quantity: 80 },
      { ingredient: "Frutos rojos congelados", quantity: 150 },
    ],
  },
  {
    type: "DECORATION",
    name: "Torta de Nuez",
    description: "Frosting de crema con espiral y crocante de nuez en la base.",
    visualStyle: "nuez",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 2,
    recipe: [
      ...
      { ingredient: "Nueces", quantity: 100 },
    ],
  },
  {
    type: "DECORATION",
    name: "Torta Franui",
    description: "Ganache de chocolate con frutas confitadas.",
    visualStyle: "franui",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 3,
    recipe: [
      ...
      { ingredient: "Frutos rojos congelados", quantity: 80 },
    ],
  },
  {
    type: "DECORATION",
  ...
  },
  {
    ...
    sortOrder: 6,
    recipe: [
      { ingredient: "Nutella", quantity: 200 },
      { ingredient: "Chocolate cobertura", quantity: 150 },
    ],
  },
  {
    type: "DECORATION",
    name: "Chocotorta",
    description: "Frosting de dulce de leche con crocante de chocolate.",
    visualStyle: "chocotorta",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 7,
    recipe: [
      { ingredient: "Dulce de leche repostero", quantity: 350 },
      { ingredient: "Chocolate cobertura", quantity: 100 },
      { ingredient: "Azúcar impalpable", quantity: 30 },
    ],
  },
  {
    type: "DECORATION",
    name: "Matilda",
    description: "Cobertura rústica de chocolate en todo el contorno.",
    visualStyle: "matilda",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 8,
    recipe: [
      { ingredient: "Chocolate cobertura", quantity: 350 },
      { ingredient: "Manteca", quantity: 60 },
    ],
  },
  {
    type: "DECORATION",
    name: "Chajá",
    description: "Merengue y crema chantilly con un toque de dulce de leche.",
    visualStyle: "chaja",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 9,
    recipe: [
      { ingredient: "Crema de leche", quantity: 350 },
      { ingredient: "Azúcar impalpable", quantity: 60 },
      { ingredient: "Dulce de leche repostero", quantity: 80 },
      { ingredient: "Huevos", quantity: 2 },
    ],
  },
  {
    type: "DECORATION",
    name: "Torta Brownie",
    description: "Merengue suizo tostado y perlas de chocolate.",
    visualStyle: "tortabrownie",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 10,
    recipe: [
      { ingredient: "Huevos", quantity: 5 },
      { ingredient: "Azúcar común", quantity: 250 },
      { ingredient: "Chocolate cobertura", quantity: 60 },
    ],
  },
  {
    type: "DECORATION",
    name: "Torta brownie con frutos rojos",
    description: "Borde de crema chantilly y frutos rojos frescos.",
    visualStyle: "frutosrojostop",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 11,
    recipe: [
      { ingredient: "Crema de leche", quantity: 200 },
      { ingredient: "Azúcar impalpable", quantity: 40 },
      { ingredient: "Frutos rojos congelados", quantity: 250 },
    ],
  },
  {
    type: "DECORATION",
    name: "Tiramisú",
    description: "Cacao amargo espolvoreado, estilo clásico italiano.",
    visualStyle: "tiramisu",
    decorationCategory: "CLASSIC",
    marginPercent: 50,
    sortOrder: 12,
    recipe: [
